...
public class LowLaunchCommand extends CommandBase {
   ...
   */
  public LowLaunchCommand(SerializerSubsystem serializer1, LauncherSubsystem launcher1, VisionSubsystem vision) {
